...
export const SPOON_TIERS = [
  { id: 'diamond', label: '다이아 수저', emoji: '💎', value: 1000, prob: 0.00001, taps: 10000, color: '#5BCEFA', glow: 'rgba(91,206,250,0.3)' },
  { id: 'gold',    label: '금수저',      emoji: '🥇', value: 10,   prob: 0.10,    taps: 100,   color: '#F5A623', glow: 'rgba(245,166,35,0.3)' },
  { id: 'silver',  label: '은수저',      emoji: '🥈', value: 5,    prob: 0.20,    taps: 50,    color: '#A0A8B0', glow: 'rgba(160,168,176,0.3)' },
  { id: 'bronze',  label: '동수저',      emoji: '🥉', value: 3,    prob: 0.30,    taps: 30,    color: '#CD7F32', glow: 'rgba(205,127,50,0.3)' },
  { id: 'stone',   label: '돌수저',      emoji: '🪨', value: 1,    prob: 0.40,    taps: 10,    color: '#6B7280', glow: 'rgba(107,114,128,0.2)' },
]
